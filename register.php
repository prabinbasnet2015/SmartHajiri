...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<div id="main" role="main">
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-7 col-sm-6 col-md-7 col-lg-4 hidden-xs hidden-sm">
							...
							<form action="php/demo-register.php" id="smart-form-register" class="smart-form client-form">
								...
								<fieldset>
									...
									<div class="row">
										...
										<section class="col col-6">
											<label class="input">
												<input type="text" name="request" placeholder="Mobile Number">
											</label>
										</section>
									</div>
 ...
 <div id="left">
            ...
            <h1>SmartLekha TERMS & CONDITIONS TEMPLATE</h1>
...
<h2>About these website terms and conditions</h2><p>We created these website terms and conditions with the help of a free website terms and conditions form developed by Contractology and available at <a href="http://www.SmartLekha.com">www.SmartLekha.com</a>.
Contractology supply a wide variety of commercial legal documents, such as <a href="#">template data protection statements</a>.
	 ...
	 <a href="#">SmartLekha.com</a>.  You must retain the credit 

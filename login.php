...
<header id="header">
	...
	<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs txt-color-white">Start Smart Lekha for your Business, Register today !</span> <a href="<?php echo APP_URL; ?>/register" class="btn btn-danger">Hello Sign Up</a> </span>
...
<div id="main" role="main">
	...
	<div id="content" class="container">
		...
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-7 col-lg-4 hidden-xs hidden-sm">
			</div>
					...
					<form action="<?Php $_SERVER['PHP_SELF']?>" method = "POST" id="login-form" class="smart-form client-form ">
						...
						<fieldset>
							...
							<section>
								...
								<div class="note">
									<a href="<?php echo APP_URL; ?>/forgotpassword">Forgot password?</a>
								</div>
							</section>
